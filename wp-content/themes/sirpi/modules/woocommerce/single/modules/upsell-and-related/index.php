...
if( !class_exists( 'Sirpi_Shop_Single_Module_Upsell_Related' ) ) {

    class Sirpi_Shop_Single_Module_Upsell_Related {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( sirpi_is_file_in_theme( __FILE__ ) ) {
                    return SIRPI_MODULE_DIR . '/woocommerce/single/modules/upsell-and-related/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( sirpi_is_file_in_theme( __FILE__ ) ) {
                    return SIRPI_MODULE_URI . '/woocommerce/single/modules/upsell-and-related/';
                } else {
        ...
        */
            function woo_load_listing( $product_style_template, $product_style_custom_template ) {
                ...
                if( $product_style_template == 'predefined' ) {
                    $type_class_instance = 'sirpi_woo_listing_type_'.$product_style_custom_template; // Type Class Instance
...
if( !function_exists('sirpi_shop_single_module_upsell_related') ) {
	function sirpi_shop_single_module_upsell_related() {
		return Sirpi_Shop_Single_Module_Upsell_Related::instance();
	}
}

sirpi_shop_single_module_upsell_related();