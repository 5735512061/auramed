...
if( !class_exists( 'Sirpi_Shop_Others_Quantity_Plus_Minus' ) ) {

    class Sirpi_Shop_Others_Quantity_Plus_Minus {
        ...
        function __construct() {
            ...
            // JS
                add_action( 'sirpi_after_woo_js', array ( $this, 'after_woo_js' ) );
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( sirpi_is_file_in_theme( __FILE__ ) ) {
                    return SIRPI_MODULE_DIR . '/woocommerce/others/quantity-plus-minus/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( sirpi_is_file_in_theme( __FILE__ ) ) {
                    return SIRPI_MODULE_URI . '/woocommerce/others/quantity-plus-minus/';
                } else {
        ...
        */
            function after_woo_js() {
                ...
                if( !is_product() && !is_cart() ) {
                    ...
                    wp_register_script( 'sirpi-woo-quantity-plus-minus', '', array ('jquery'), false, true );
                    wp_enqueue_script( 'sirpi-woo-quantity-plus-minus' );
                    ...
                    if( !empty($js) ) {
                        wp_add_inline_script( 'sirpi-woo-quantity-plus-minus', $js );
                    }
...
if( !function_exists('sirpi_shop_others_quantity_plus_minus') ) {
	function sirpi_shop_others_quantity_plus_minus() {
        $reflection = new ReflectionClass('Sirpi_Shop_Others_Quantity_Plus_Minus');
        return $reflection->newInstanceWithoutConstructor();
	}
}

Sirpi_Shop_Others_Quantity_Plus_Minus::instance();