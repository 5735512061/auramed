...
if( !class_exists( 'Sirpi_Woo_Listing_Tag' ) ) {

    class Sirpi_Woo_Listing_Tag {
        ...
        */
            function woo_default_settings() {
                ...
                $this->settings = apply_filters( 'sirpi_woo_tag_page_default_settings', $this->settings );
...
if( !function_exists('sirpi_woo_listing_tag') ) {
	function sirpi_woo_listing_tag() {
		return Sirpi_Woo_Listing_Tag::instance();
	}
}

sirpi_woo_listing_tag();