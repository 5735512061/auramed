...
if( !class_exists( 'Sirpi_Woo_Listing_Option_Content_Element_Group' ) ) {

    class Sirpi_Woo_Listing_Option_Content_Element_Group extends Sirpi_Woo_Listing_Option_Core {
        ...
        function render_backend() {
            ...
            add_filter( 'sirpi_woo_custom_product_template_content_options', array( $this, 'woo_custom_product_template_content_options'), 50, 1 );
        }
...
if( !function_exists('sirpi_woo_listing_option_content_element_group') ) {
	function sirpi_woo_listing_option_content_element_group() {
		return Sirpi_Woo_Listing_Option_Content_Element_Group::instance();
	}
}

sirpi_woo_listing_option_content_element_group();