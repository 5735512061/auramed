...
if( ! function_exists( 'sirpi_shop_woo_loop_product_content' ) ) {

	function sirpi_shop_woo_loop_product_content() {
		...
		if($product_content_enable) {
			...
			if($product_content_content) {
				...
				sirpi_shop_woo_loop_product_content_content_setup($product_content_content);
				...
				echo '<div class="product-details">';
					...
					// Others
					do_action('sirpi_woo_loop_product_content_content', 'content');
					remove_all_actions('sirpi_woo_loop_product_content_content');
				echo '</div>';
	...
	add_action( 'woocommerce_shop_loop_item_title', 'sirpi_shop_woo_loop_product_content', 10 );
