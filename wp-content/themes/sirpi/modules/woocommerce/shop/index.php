...
if( !class_exists( 'Sirpi_Woo_Listing_Shop' ) ) {

    class Sirpi_Woo_Listing_Shop {
        ...
        */
            function woo_default_settings() {
                ...
                $this->settings = apply_filters( 'sirpi_woo_shop_page_default_settings', $this->settings );
...
if( !function_exists('sirpi_woo_listing_shop') ) {
	function sirpi_woo_listing_shop() {
		return Sirpi_Woo_Listing_Shop::instance();
	}
}

sirpi_woo_listing_shop();