			...
			$output .= '<div class="wdt-social-icons-container">';
				$output .= '<ul class="wdt-social-icons-list">';
					if($item['facebook_link']['url'] != '') {
						...
						$link_start = '<a href="'.esc_url( $item['facebook_link']['url'] ).'"'. $target . $nofollow.'><span>'.esc_html__('Fb', 'wdt-elementor-addon').'</span>';
						$link_end = '</a>';

						$output .= '<li>';
							$output .= $link_start;
								/* ob_start();
								\Elementor\Icons_Manager::render_icon(  array (
									'value' => 'wdticon-facebook',
									'library' => 'fa-brands',
								) );
								$output .= ob_get_clean(); */
							$output .= $link_end;
					...
					if($item['twitter_link']['url'] != '') {
						...
						$link_start = '<a href="'.esc_url( $item['twitter_link']['url'] ).'"'. $target . $nofollow.'><span>'.esc_html__('Tw', 'wdt-elementor-addon').'</span>';
						$link_end = '</a>';
					...
					if($item['youtube_link']['url'] != '') {
						...
						$link_start = '<a href="'.esc_url( $item['youtube_link']['url'] ).'"'. $target . $nofollow.'><span>'.esc_html__('Yt', 'wdt-elementor-addon').'</span>';
						$link_end = '</a>';
					...
					if($item['linkedin_link']['url'] != '') {
						...
						$link_start = '<a href="'.esc_url( $item['linkedin_link']['url'] ).'"'. $target . $nofollow.'><span>'.esc_html__('Li', 'wdt-elementor-addon').'</span>';
						$link_end = '</a>';
