	...
	public function create_elementor_controls($elementor_object) {
		...
		$elementor_object->start_controls_section( 'wdt_section_content', array(
			...
			$elementor_object->add_control( 'animation_type', array(
				...
				'options' => array(
					'wdt-fade-zoom'  => esc_html__( 'Fade Zoom', 'wdt-elementor-addon' ),
					'wdt-fade-slide' => esc_html__( 'Fade Slide', 'wdt-elementor-addon' ),
				)
			));
		...
		$elementor_object->start_controls_section( 'wdt_section_settings', array(
			...
			$elementor_object->add_control( 'on_click_element', array(
				...
				'options' => array(
					...
					'image-n-label' => esc_html__( 'Image + Label', 'wdt-elementor-addon' )
			...
			$elementor_object->add_control( 'on_click_element_image', array(
				...
				'condition' => array(
					'trigger_type' => 'on-click',
					'on_click_element' => array ('image', 'image-n-icon', 'image-n-label'),
				)
			));
			...
			$elementor_object->add_control( 'on_click_element_label', array(
				...
				'condition' => array(
					'trigger_type' => 'on-click',
					'on_click_element' => array ('label', 'label-n-icon', 'image-n-label'),
				)
			));
		...
		// Trigger Element
			$this->cc_style->get_style_controls($elementor_object, array (
				...
				'condition' => array(
					'trigger_type' => 'on-click',
					'on_click_element' => array ( 'label', 'label-n-icon', 'image', 'image-n-icon', 'image-n-label' )
				),
				'styles' => array (
					'alignment' => array (
