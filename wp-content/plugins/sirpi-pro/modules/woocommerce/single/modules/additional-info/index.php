...
if( !class_exists( 'Sirpi_Shop_Single_Module_Additional_Info' ) ) {

    class Sirpi_Shop_Single_Module_Additional_Info {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( sirpi_is_file_in_theme( __FILE__ ) ) {
                    return SIRPI_MODULE_DIR . '/woocommerce/single/modules/additional-info/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( sirpi_is_file_in_theme( __FILE__ ) ) {
                    return SIRPI_MODULE_URI . '/woocommerce/single/modules/additional-info/';
                } else {
...
if( !function_exists('sirpi_shop_single_module_additional_info') ) {
	function sirpi_shop_single_module_additional_info() {
        $reflection = new ReflectionClass('Sirpi_Shop_Single_Module_Additional_Info');
        return $reflection->newInstanceWithoutConstructor();
	}
}

if( class_exists( 'Sirpi_Shop_Single_Module_Custom_template' ) ) {
    Sirpi_Shop_Single_Module_Additional_Info::instance();
}