...
if( !class_exists( 'Sirpi_Shop_Single_Module_Buy_Now' ) ) {

    class Sirpi_Shop_Single_Module_Buy_Now {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( sirpi_is_file_in_theme( __FILE__ ) ) {
                    return SIRPI_MODULE_DIR . '/woocommerce/single/modules/buy-now/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( sirpi_is_file_in_theme( __FILE__ ) ) {
                    return SIRPI_MODULE_URI . '/woocommerce/single/modules/buy-now/';
                } else {
...
if( !function_exists('sirpi_shop_single_module_buy_now') ) {
	function sirpi_shop_single_module_buy_now() {
        $reflection = new ReflectionClass('Sirpi_Shop_Single_Module_Buy_Now');
        return $reflection->newInstanceWithoutConstructor();
	}
}

if( class_exists( 'Sirpi_Shop_Single_Module_Custom_template' ) ) {
    Sirpi_Shop_Single_Module_Buy_Now::instance();
}