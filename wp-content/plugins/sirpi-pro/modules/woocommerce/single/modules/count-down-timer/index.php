...
if( !class_exists( 'Sirpi_Shop_Single_Module_Count_Down_Timer' ) ) {

    class Sirpi_Shop_Single_Module_Count_Down_Timer {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( sirpi_is_file_in_theme( __FILE__ ) ) {
                    return SIRPI_MODULE_DIR . '/woocommerce/single/modules/count-down-timer/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( sirpi_is_file_in_theme( __FILE__ ) ) {
                    return SIRPI_MODULE_URI . '/woocommerce/single/modules/count-down-timer/';
                } else {
...
if( !function_exists('sirpi_shop_single_module_count_down_timer') ) {
	function sirpi_shop_single_module_count_down_timer() {
        $reflection = new ReflectionClass('Sirpi_Shop_Single_Module_Count_Down_Timer');
        return $reflection->newInstanceWithoutConstructor();
	}
}

if( class_exists( 'Sirpi_Shop_Single_Module_Custom_template' ) ) {
    Sirpi_Shop_Single_Module_Count_Down_Timer::instance();
}