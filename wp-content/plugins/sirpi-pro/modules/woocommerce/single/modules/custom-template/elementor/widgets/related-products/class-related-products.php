...
class Sirpi_Shop_Widget_Related_Products extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Product Single - Related Products', 'sirpi-pro' );
	}
		...
		if($settings['product_id'] != '') {
			...
			$output .= '<div class="wdt-product-related-products '.$settings['class'].'">';
				...
				if($settings['product_style_template'] == 'admin') {
					$product_style_template = sirpi_customizer_settings( 'wdt-single-product-related-style-template' );
				} else {
