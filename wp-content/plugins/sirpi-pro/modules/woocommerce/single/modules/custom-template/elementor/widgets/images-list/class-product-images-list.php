...
class Sirpi_Shop_Widget_Product_Images_List extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Product Single - Images List', 'sirpi-pro' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section( 'product_images_list_section', array(
			...
			$this->add_control( 'include_featured_image', array(
				...
				'description'  => esc_html__('If you wish, you can include featured image in this listing.', 'sirpi-pro'),
			...
			$this->add_control( 'include_gallery_images', array(
				'label'        => esc_html__( 'Include Gallery Images', 'sirpi-pro' ),
				'type'         => Controls_Manager::SWITCHER,
				'description'  => esc_html__('If you wish, you can include gallery imagea in this listing.', 'sirpi-pro'),
				'label_on'     => esc_html__( 'yes', 'sirpi-pro' ),
				'label_off'    => esc_html__( 'no', 'sirpi-pro' ),
				'default'      => 'true',
				'return_value' => 'true',
			...
			$this->add_control( 'columns', array(
				...
				'description' => esc_html__( 'Number columns to show images in.', 'sirpi-pro' ),
				'options'     => array( 1 => 1, 2 => 2 ),
				'default'     => 2,
	        ) );

			$this->add_control( 'enable_grid_space', array(
				'label'        => esc_html__( 'Enable Grid Space', 'sirpi-pro' ),
				'type'         => Controls_Manager::SWITCHER,
				'description'  => esc_html__('If you wish, you can enable grid space in this gallery.', 'sirpi-pro'),
				'label_on'     => esc_html__( 'yes', 'sirpi-pro' ),
				'label_off'    => esc_html__( 'no', 'sirpi-pro' ),
				'default'      => '',
				'return_value' => 'true',
