...
if( !class_exists( 'Sirpi_Shop_Others_Search' ) ) {

    class Sirpi_Shop_Others_Search {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( sirpi_is_file_in_theme( __FILE__ ) ) {
                    return SIRPI_MODULE_DIR . '/woocommerce/others/search/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( sirpi_is_file_in_theme( __FILE__ ) ) {
                    return SIRPI_MODULE_URI . '/woocommerce/others/search/';
                } else {
         ...
         */
            function module_add_new_page_template( $templates ) {
                ...
                $templates = array_merge (
                    $templates,
                    array (
                        'tpl-product-search-listing.php' => esc_html__('Product Search Listing Template', 'sirpi-pro')
                    )
                );
...
if( !function_exists('sirpi_shop_others_search') ) {
	function sirpi_shop_others_search() {
        $reflection = new ReflectionClass('Sirpi_Shop_Others_Search');
        return $reflection->newInstanceWithoutConstructor();
	}
}

Sirpi_Shop_Others_Search::instance();