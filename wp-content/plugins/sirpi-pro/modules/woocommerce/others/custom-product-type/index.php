...
if( !class_exists( 'Sirpi_Shop_Others_Custom_Product_Type' ) ) {

    class Sirpi_Shop_Others_Custom_Product_Type {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( sirpi_is_file_in_theme( __FILE__ ) ) {
                    return SIRPI_MODULE_DIR . '/woocommerce/others/custom-product-type/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( sirpi_is_file_in_theme( __FILE__ ) ) {
                    return SIRPI_MODULE_URI . '/woocommerce/others/custom-product-type/';
                } else {
...
if( !function_exists('sirpi_shop_others_custom_product_type') ) {
	function sirpi_shop_others_custom_product_type() {
        $reflection = new ReflectionClass('Sirpi_Shop_Others_Custom_Product_Type');
        return $reflection->newInstanceWithoutConstructor();
	}
}

Sirpi_Shop_Others_Custom_Product_Type::instance();