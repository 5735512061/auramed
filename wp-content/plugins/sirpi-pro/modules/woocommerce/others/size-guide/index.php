...
if( !class_exists( 'Sirpi_Shop_Others_Size_Guide' ) ) {

    class Sirpi_Shop_Others_Size_Guide {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( sirpi_is_file_in_theme( __FILE__ ) ) {
                    return SIRPI_MODULE_DIR . '/woocommerce/others/size-guide/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( sirpi_is_file_in_theme( __FILE__ ) ) {
                    return SIRPI_MODULE_URI . '/woocommerce/others/size-guide/';
                } else {
...
if( !function_exists('sirpi_shop_others_size_guide') ) {
	function sirpi_shop_others_size_guide() {
        $reflection = new ReflectionClass('Sirpi_Shop_Others_Size_Guide');
        return $reflection->newInstanceWithoutConstructor();
	}
}

Sirpi_Shop_Others_Size_Guide::instance();