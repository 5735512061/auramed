...
if( !class_exists( 'Sirpi_Shop_Others_Wishlist' ) ) {

    class Sirpi_Shop_Others_Wishlist {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( sirpi_is_file_in_theme( __FILE__ ) ) {
                    return SIRPI_MODULE_DIR . '/woocommerce/others/wishlist/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( sirpi_is_file_in_theme( __FILE__ ) ) {
                    return SIRPI_MODULE_URI . '/woocommerce/others/wishlist/';
                } else {
...
if( !function_exists('sirpi_shop_others_wishlist') ) {
	function sirpi_shop_others_wishlist() {
        $reflection = new ReflectionClass('Sirpi_Shop_Others_Wishlist');
        return $reflection->newInstanceWithoutConstructor();
	}
}

Sirpi_Shop_Others_Wishlist::instance();