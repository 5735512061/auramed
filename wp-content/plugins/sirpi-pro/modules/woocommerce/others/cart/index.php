...
if( !class_exists( 'Sirpi_Shop_Others_Cart' ) ) {

    class Sirpi_Shop_Others_Cart {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( sirpi_is_file_in_theme( __FILE__ ) ) {
                    return SIRPI_MODULE_DIR . '/woocommerce/others/cart/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( sirpi_is_file_in_theme( __FILE__ ) ) {
                    return SIRPI_MODULE_URI . '/woocommerce/others/cart/';
                } else {
...
if( !function_exists('sirpi_shop_others_cart') ) {
	function sirpi_shop_others_cart() {
        $reflection = new ReflectionClass('Sirpi_Shop_Others_Cart');
        return $reflection->newInstanceWithoutConstructor();
	}
}

Sirpi_Shop_Others_Cart::instance();