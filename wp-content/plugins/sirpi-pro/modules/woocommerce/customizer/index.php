...
if( !class_exists( 'Sirpi_Woo_Listing_Customizer_Settings' ) ) {

    class Sirpi_Woo_Listing_Customizer_Settings {
            ...
            function register( $wp_customize ) {
                ...
                $wp_customize->add_panel(
                    new Sirpi_Customize_Panel(
                        ...
                        array(
                            'title'    => esc_html__('Sirpi - WooCommerce', 'sirpi-pro'),
                            'priority' => sirpi_customizer_panel_priority( 'woocommerce' )
                        )
                    )
                );
...
if( !function_exists('sirpi_woo_listing_customizer_settings') ) {
	function sirpi_woo_listing_customizer_settings() {
		return Sirpi_Woo_Listing_Customizer_Settings::instance();
	}
}

sirpi_woo_listing_customizer_settings();
