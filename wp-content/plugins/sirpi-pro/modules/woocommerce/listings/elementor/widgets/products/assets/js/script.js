( function( $ ) {
	...
	var wdtShopProducts = function($scope, $){
		...
		$scope.find('.wdt-products-container.swiper-container').each(function() {
			...
			var swiperIterator = $swiperItem.data('moduleid');
		...
		if($scope.hasClass('elementor-element-edit-mode')) {
			...
			var customCSS = jQuery('body', parent.document).find('style[id="sirpi-woo-non-archive-inline-css"]').text();
			jQuery('body', parent.document).find('style[id="sirpi-woo-non-archive-inline-css"]').remove();
			...
			var customJS = jQuery('body', parent.document).find('script[id="sirpi-woo-non-archive-js-after"]').text();
			jQuery('body', parent.document).find('script[id="sirpi-woo-non-archive-js-after"]').remove();
