...
if( !class_exists( 'Sirpi_Woo_Listing_Type_Custom' ) ) {

    class Sirpi_Woo_Listing_Type_Custom {
        ...
        function __construct() {
            ...
            /* Initialize Type */
                ...
                $this->type_name = esc_html__('Custom', 'sirpi-pro');
        ...
        */
            function set_type_options() {
                ...
                if( strpos($this->custom_template, 'predefined-template-') !== false ) {
                    ...
                    $field_key = str_replace('predefined-template-', 'sirpi-woo-product-style-template-',  $this->custom_template);
                    ...
                    $custom_options = ( isset($dtcs_product_templates['sirpi-woo-product-style-templates'][$field_key]) && !empty($dtcs_product_templates['sirpi-woo-product-style-templates'][$field_key]) ) ? $dtcs_product_templates['sirpi-woo-product-style-templates'][$field_key] : array ();
            ...
            function for_non_archive_listing() {
                ...
                /* Assets Load */
                    ...
                    // CSS
                        ...
                        wp_register_style( 'sirpi-woo-non-archive', '', array (), SIRPI_PRO_VERSION, 'all' );
...
if( !function_exists('sirpi_woo_listing_type_custom') ) {
	function sirpi_woo_listing_type_custom() {
		return Sirpi_Woo_Listing_Type_Custom::instance();
	}
}

sirpi_woo_listing_type_custom();