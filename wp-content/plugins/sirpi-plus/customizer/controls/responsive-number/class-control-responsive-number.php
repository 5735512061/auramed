...
class Sirpi_Customize_Control_Responsive_Number extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'sirpi-plus-responsive-number-control', SIRPI_PLUS_DIR_URL . 'customizer/controls/responsive-number/responsive-number.js', array( 'jquery', 'customize-base' ), SIRPI_PLUS_VERSION, true );
		wp_enqueue_style( 'sirpi-plus-responsive-number-control',  SIRPI_PLUS_DIR_URL . 'customizer/controls/responsive-number/responsive-number.css', null, SIRPI_PLUS_VERSION );
	}
