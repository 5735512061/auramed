...
class Sirpi_Customize_Control_Slider extends WP_Customize_Control {
	...
	*/
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'sirpi-plus-slider-control', SIRPI_PLUS_DIR_URL.'customizer/controls/slider/slider.js', array( 'jquery', 'customize-base' ), SIRPI_PLUS_VERSION, true );
		wp_enqueue_style( 'sirpi-plus-slider-control',  SIRPI_PLUS_DIR_URL.'customizer/controls/slider/slider.css', null, SIRPI_PLUS_VERSION );
	}
