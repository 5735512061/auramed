...
class Sirpi_Customize_Control_Color extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_script( 'sirpi-plus-color-control', SIRPI_PLUS_DIR_URL.'customizer/controls/color/color.js', array( 'jquery', 'customize-base' , 'sirpi-plus-customizer-color-picker' ), SIRPI_PLUS_VERSION, true );
		wp_enqueue_style( 'sirpi-plus-color-control',  SIRPI_PLUS_DIR_URL.'customizer/controls/color/color.css', null, SIRPI_PLUS_VERSION );
	}
