...
class Sirpi_Customize_Control_Separator extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_style( 'sirpi-plus-separator-control',  SIRPI_PLUS_DIR_URL.'customizer/controls/separator/separator.css', null, SIRPI_PLUS_VERSION );
	}
