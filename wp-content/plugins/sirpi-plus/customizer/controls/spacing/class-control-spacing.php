...
class Sirpi_Customize_Control_Spacing extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_script( 'sirpi-plus-spacing-control', SIRPI_PLUS_DIR_URL.'customizer/controls/spacing/spacing.js', array( 'jquery', 'customize-base' ), SIRPI_PLUS_VERSION, true );
		wp_enqueue_style( 'sirpi-plus-spacing-control',  SIRPI_PLUS_DIR_URL.'customizer/controls/spacing/spacing.css', null, SIRPI_PLUS_VERSION );
	}
