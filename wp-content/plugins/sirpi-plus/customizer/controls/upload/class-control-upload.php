...
class Sirpi_Customize_Control_Upload extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_style( 'sirpi-plus-upload-control',  SIRPI_PLUS_DIR_URL.'customizer/controls/upload/upload.css', null, SIRPI_PLUS_VERSION );
		wp_enqueue_script( 'sirpi-plus-upload-control', SIRPI_PLUS_DIR_URL.'customizer/controls/upload/upload.js', array( 'jquery', 'customize-base' ), SIRPI_PLUS_VERSION, true );
	}
                ...
                <div class="upload-file">
                    <div class="attachment-file-view upload-file">
                        ...
                        <div class="actions">
                            ...
                            <button type="button" class="button upload-file-button"><?php esc_attr_e( 'Select File', 'sirpi-plus' ); ?></button>
                        </div>
                    </div>
                </div>
			</div>
