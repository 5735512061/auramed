...
class Sirpi_Customize_Control_Fontawesome extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_script( 'sirpi-plus-fontawesome-control', SIRPI_PLUS_DIR_URL . 'customizer/controls/fontawesome/fontawesome.js', array( 'jquery', 'customize-base' ), SIRPI_PLUS_VERSION, true );
		wp_enqueue_style( 'sirpi-plus-fontawesome-control',  SIRPI_PLUS_DIR_URL . 'customizer/controls/fontawesome/fontawesome.css', null, SIRPI_PLUS_VERSION );

		wp_enqueue_style( 'sirpi-plus-fontawesome',  SIRPI_PLUS_DIR_URL . 'customizer/assets/css/fontawesome-all.css', array(),SIRPI_PLUS_VERSION, 'all' );
	}
	...
	public function to_json() {
		...
		$this->json['reset'] = esc_html__( "Reset", "sirpi-plus") .' '.esc_html( $this->label );
