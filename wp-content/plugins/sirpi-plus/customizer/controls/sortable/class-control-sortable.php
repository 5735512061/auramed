...
class Sirpi_Customize_Control_Sortable extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'sirpi-plus-sortable-control', SIRPI_PLUS_DIR_URL.'customizer/controls/sortable/sortable.js', array( 'jquery', 'customize-base' ), SIRPI_PLUS_VERSION, true );
		wp_enqueue_style( 'sirpi-plus-sortable-control',  SIRPI_PLUS_DIR_URL.'customizer/controls/sortable/sortable.css', null, SIRPI_PLUS_VERSION );
	}
