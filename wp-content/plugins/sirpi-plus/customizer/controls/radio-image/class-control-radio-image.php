...
class Sirpi_Customize_Control_Radio_Image extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'sirpi-plus-radio-image-control', SIRPI_PLUS_DIR_URL . 'customizer/controls/radio-image/radio-image.js', array( 'jquery', 'customize-base' ), SIRPI_PLUS_VERSION, true );
		wp_enqueue_style( 'sirpi-plus-radio-image-control',  SIRPI_PLUS_DIR_URL . 'customizer/controls/radio-image/radio-image.css', null, SIRPI_PLUS_VERSION );
	}
