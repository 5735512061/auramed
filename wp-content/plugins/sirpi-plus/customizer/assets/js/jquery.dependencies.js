;(function ( $, window, document, undefined ) {
    'use strict';
    $.SIRPIPLUSWPCUSTOMIZER = $.SIRPIPLUSWPCUSTOMIZER || {};

	$.SIRPIPLUSWPCUSTOMIZER.DEPENDENCY = function( el, param ) {
	...
	$.fn.SIRPIPLUSWPCUSTOMIZER_DEPENDENCY = function ( param ) {
		return this.each(function () {
			new $.SIRPIPLUSWPCUSTOMIZER.DEPENDENCY( this, param );
		});
	};

	$(document).ready( function() {
		$('.wp-customizer').SIRPIPLUSWPCUSTOMIZER_DEPENDENCY();
	});
