...
if( !class_exists( 'SirpiPlusH1Settings' ) ) {
    class SirpiPlusH1Settings {
        ...
        function __construct() {
            ...
            $this->selector = apply_filters( 'sirpi_h1_selector', array( 'h1' ) );
            $this->settings = sirpi_customizer_settings('h1_typo');

            add_filter( 'sirpi_plus_customizer_default', array( $this, 'default' ) );
            add_action( 'customize_register', array( $this, 'register' ), 20);

            add_filter( 'sirpi_h1_typo_customizer_update', array( $this, 'h1_typo_customizer_update' ) );
        ...
        function register( $wp_customize ) {
            ...
            $wp_customize->add_section(
                new Sirpi_Customize_Section(
                    ...
                    'site-h1-section',
                    array(
                        'title'    => esc_html__('H1 Typography', 'sirpi-plus'),
             ...
             */
                $wp_customize->add_setting(
                    SIRPI_CUSTOMISER_VAL . '[h1_typo]', array(
                        'type'    => 'option',
                    )
                );
                ...
                $wp_customize->add_control(
                    new Sirpi_Customize_Control_Typography(
                        $wp_customize, SIRPI_CUSTOMISER_VAL . '[h1_typo]', array(
                            'type'    => 'wdt-typography',
                            'section' => 'site-h1-section',
                            'label'   => esc_html__( 'H1 Tag', 'sirpi-plus')
                        )
                    )
                );
             ...
             */
                $wp_customize->add_setting(
                    SIRPI_CUSTOMISER_VAL . '[h1_color]', array(
                        'default' => '',
                        'type'    => 'option',
                    )
                );
                ...
                $wp_customize->add_control(
                    new WP_Customize_Color_Control(
                        $wp_customize, SIRPI_CUSTOMISER_VAL . '[h1_color]', array(
        ...
        function h1_typo_customizer_update( $defaults ) {
            $h1_typo = sirpi_customizer_settings( 'h1_typo' );
            if( !empty( $h1_typo ) ) {
                return  $h1_typo;
            }
            return $defaults;
        ...
        function base_style( $style ) {
            $css   = '';
            $color = sirpi_customizer_settings('h1_color');
