...
if( !class_exists( 'SirpiPlusSidebar' ) ) {
    class SirpiPlusSidebar {
        ...
        function load_modules() {
            include_once SIRPI_PLUS_DIR_PATH.'modules/sidebar/customizer/index.php';
        }

        function frontend() {
            add_filter('sirpi_primary_classes', array( $this, 'primary_classes' ), 10 );
            add_filter('sirpi_secondary_classes', array( $this, 'secondary_classes' ), 10 );
        }
