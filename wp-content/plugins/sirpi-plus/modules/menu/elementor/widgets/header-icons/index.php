...
if( !class_exists( 'SirpiPlusHeaderIconsWidget' ) ) {
    class SirpiPlusHeaderIconsWidget {
        ...
        function register_widgets( $widgets_manager ) {
            require SIRPI_PLUS_DIR_PATH. 'modules/menu/elementor/widgets/header-icons/class-widget-header-icons.php';
            $widgets_manager->register( new \Elementor_Header_Icons() );
        }

        function register_widget_styles() {
            wp_register_style( 'wdt-header-icons',
                SIRPI_PLUS_DIR_URL . 'modules/menu/elementor/widgets/assets/css/header-icons.css', array(), SIRPI_PLUS_VERSION );

            if( function_exists( 'is_woocommerce' ) ) {
                wp_register_style( 'wdt-header-carticons',
                    SIRPI_PLUS_DIR_URL . 'modules/menu/elementor/widgets/assets/css/header-carticon.css', array(), SIRPI_PLUS_VERSION );
            }
        }

        function register_widget_scripts() {
            wp_register_script( 'jquery-nicescroll',
                SIRPI_PLUS_DIR_URL . 'modules/menu/elementor/widgets/assets/js/jquery.nicescroll.js', array(), SIRPI_PLUS_VERSION, true );
            wp_register_script( 'wdt-header-icons',
                SIRPI_PLUS_DIR_URL . 'modules/menu/elementor/widgets/assets/js/header-icons.js', array(), SIRPI_PLUS_VERSION, true );
        }
...
SirpiPlusHeaderIconsWidget::instance();
