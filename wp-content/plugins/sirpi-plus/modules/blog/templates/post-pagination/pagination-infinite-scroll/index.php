...
if( !class_exists( 'BlogPaginationInfiniteScroll' ) ) {
    class BlogPaginationInfiniteScroll {
        ...
        function enqueue_js_assets() {
        	wp_enqueue_script( 'post-infinite', SIRPI_PLUS_DIR_URL . 'modules/blog/assets/js/post-infinite.js', array(), SIRPI_PLUS_VERSION, true );
			wp_localize_script('post-infinite', 'sirpi_urls', array(
