...
if( !class_exists( 'SirpiPlusHeaderElementor' ) ) {
    class SirpiPlusHeaderElementor {
        ...
        function frontend() {
            add_filter( 'sirpi_print_header_template', array( $this, 'register_header_template' ), 10, 1 );
        }
		...
		function register_header_template( $id ) {
            ...
            return apply_filters( 'sirpi_plus_header_content', $content );
		}
    }
}

SirpiPlusHeaderElementor::instance();