...
class CSFramework_Option_background extends CSFramework_Options {
  ...
  public function output() {
    ...
    $frame_title  = ( isset( $frame_title  ) ) ? $frame_title  : esc_attr__( 'Upload', 'wedesigntech-ultimate-booking-addon' );
    $insert_title = ( isset( $insert_title ) ) ? $insert_title : esc_attr__( 'Use Image', 'wedesigntech-ultimate-booking-addon' );
