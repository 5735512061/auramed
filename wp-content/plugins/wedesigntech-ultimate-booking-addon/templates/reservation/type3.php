...
?>
<div class="dt-sc-reserve-appointment type3 <?php echo esc_attr($class); ?>"><?php
	// Appointment title...
	if( $title != '')
	...
	if( isset($_REQUEST['action'] ) && ( $_REQUEST['action'] === "success" || $_REQUEST['action'] === "error" ) ):
        ...
        <div class="column dt-sc-one-third">
            <?php
            $orgdateraw = new DateTime();
            $orgdate = $orgdateraw->format('d-m-Y');
            $orgdaterf = $orgdateraw->format('Y-m-d');
            ?>
            <input type="hidden" class="dt-month-year" name="month_year" value="<?php echo esc_attr($orgdate); ?>" data-currentdate="<?php echo esc_attr($orgdate); ?>" data-currentdaterf="<?php echo esc_attr($orgdaterf); ?>" />

            <div class="aligncenter">
                <a href="#" class="dt-sc-button medium bordered show-calendar"><?php esc_html_e('Show Calendar','wedesigntech-ultimate-booking-addon');?></a>
            </div>
        </div>
        ...
        <div class="column dt-sc-one-half first">
            <div id="caldatepicker" style="display:none;"></div>
        </div>
        <div class="column dt-sc-one-half">
            <div id="caldatepickerContent"></div>
        </div>
